...
action :before_compile do
  ...
  include_recipe "#{new_resource.node_type}::install_from_source"

  if new_resource.npm
    begin
      include_recipe '#{new_resource.node_type}::npm'
    rescue
      Chef::Log.debug "The npm package is already packaged on #{new_resource.node_type}"
    end
  end
